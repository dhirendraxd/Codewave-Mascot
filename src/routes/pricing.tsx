  ...
  head: () => ({
    meta: [
      { title: "Pricing Nepal — MemoryMesh" },
      {
        name: "description",
        content:
          "नेपाली users को लागि सरल NPR plans। Free बाट सुरु गर्नुहोस्, growth सँगै upgrade गर्नुहोस्।",
      },
...
const plans = [
  {
    ...
    features: [
      "प्रति महिना 100 voice memories",
      "AI cleanup + smart buckets",
      "Connection graph",
      ...
      <section className="bg-aurora">
        <div className="mx-auto w-full px-4 py-20 text-center sm:px-6 lg:px-10 lg:py-28">
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card/50 px-3 py-1 text-xs text-muted-foreground backdrop-blur">
            <span className="h-1.5 w-1.5 rounded-full bg-primary" /> Nepal
            Pricing
          </span>
